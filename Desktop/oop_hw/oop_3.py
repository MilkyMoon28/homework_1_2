...
class Lecturer(Mentor):
    ...
    def __lt__(self, other_lecturer):
        if not isinstance(other_lecturer, Lecturer):
            ...
            if compare:
                print(
                    f'{self.name} {self.surname} проводит лекции хуже ,чем {other_lecturer.name} {other_lecturer.surname}')
            else:
                print(
                    f'{self.name} {self.surname} проводит лекции лучше ,чем {other_lecturer.name} {other_lecturer.surname}')
